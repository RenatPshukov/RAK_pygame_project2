...
def game_over(over_background):
    ...
    while show:
        ...
        # отрисовываем задний фон
        screen.blit(over_background, (0, 0))
...
# TODO Функция отсчёта перед началом боя
def time_report():
    # задаём задний фон
